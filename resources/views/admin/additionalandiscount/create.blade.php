            ...
            <div class="card m-1">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        <form action="{{ url('AdditionalAndDiscount') }}" method="POST" enctype="multipart/form-data">
                            @csrf()
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="top-left">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label>Additional</label>
                                        <input required class="form-control" type="number" id="additional" name="additional"placeholder="0.00">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="top-left">
                                    <label>Discount</label>
                                        <input required class="form-control" type="number" id="discount" name="discount"placeholder="0.00">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="top-left">

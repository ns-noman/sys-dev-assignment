                ...
                <div class="row">
                    <section class="col-lg-6">
                        <div class="card card-primary">
                            ...
                            <form action="{{ route('checklists.store') }}" method="POST" id="createForm">
                                @csrf()
                                <div class="card-body">
                                    <div class="row">
                    ...
                    <section class="col-lg-6">
                        <div class="card">
                            <div class="card-header bg-primary p-1">
                                <h3 class="card-title">
                                    <a href="{{ url('/checklists/report-view') }}"class="btn btn-warning shadow rounded m-0" target="_blank">
                                            <span>View Report</span></i></a>
                                    <a href="{{ url('search-view') }}"class="btn btn-light shadow rounded m-0">
...
<script type="text/javascript">
    $('.btn-add').on('click', function(){
        ...
        tbody +=     '<input type="hidden" name="description[]" value="' + description + '" />'

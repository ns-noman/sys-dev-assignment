                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-12 col-md-12 col-lg-6">
                                            ...
                                            <select class="form-control" name="roleAutoID">
                                                ...
                                                @foreach ($role as $item)
                                                    <option {{ $user->roleAutoID== $item->id? 'selected':'' }} value="{{ $item->id }}">{{ $item->role }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group col-sm-12 col-md-12 col-lg-6">
                                        ...
                                        <div class="form-group col-sm-12 col-md-12 col-lg-6">
                                            ...
                                            <input value="{{ $user->contact_no }}" type="number" class="form-control" name="contact_no"
                                                placeholder="01800000000">
                                        </div>
                                        <div class="form-group col-sm-12 col-md-12 col-lg-6">
                                            <label>Reference Person</label>
                                            <input value="{{ $user->reference_by }}" type="text" class="form-control" name="reference_by"
